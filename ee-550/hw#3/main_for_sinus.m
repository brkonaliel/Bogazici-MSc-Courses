...
dsigmoid =@(x) 2.*exp(-x)./((1+exp(-x)).^2);

% Layers and neurons 
neurons = [dummy(2)+1, 15, 15, 1];
...
% Get 10 new samples and compare their labels with trained ANN
X_samples = create_random_sinus(10);
