function [test_set, class_names] = create_test_histograms()
...
%         dsift_binary_histogram_500= [];
        ...
        for ii=1:length(random_vector.random_vector)
            ...
            j = j+1;
            % getting test images after j>20
            if j > 20
        ...
        test_set(k).sift_histogram_100 = sift_histogram_100;
        test_set(k).sift_histogram_500 = sift_histogram_500;
        test_set(k).sift_binary_histogram_100 = sift_binary_histogram_100;
        test_set(k).sift_binary_histogram_500 = sift_binary_histogram_500;
        test_set(k).dsift_histogram_100 = dsift_histogram_100;
        test_set(k).dsift_binary_histogram_100 = dsift_binary_histogram_100;
    end
    save('/Users/burakonal/Desktop/edu_backup/ee-58j/PIRC2017_02/test_set.mat','test_set');
end