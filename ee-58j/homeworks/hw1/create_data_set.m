function [data_set, class_names] = create_data_set(data_path, bin_size, NumNeighbors, image_size, window_size, norm_value)
...
%             lbp_histogram = lbp_histogram/calculate_p_norm(lbp_histogram,norm_value);
    ...
    data_set(i).hsv = hsv_cell;
    data_set(i).hog = hog_cell;
    data_set(i).lbp = lbp_cell;
    clear hsv_cell;
    clear hog_cell;
    clear hsv_cell;
end
